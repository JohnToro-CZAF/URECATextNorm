...
# See the License for the spuage governing permissions and
...
from utils import get_src_and_dst_for_alignment
        ...
        with open(fn, "r", encoding="utf-8") as f:
            ...
            for line in f:
                ...
                if not isdir(classdir):
                    mkdir(classdir)
                src, dst, _, _ = get_src_and_dst_for_alignment(semiotic_class, written, spoken)
                if src == "" or dst == "":
                    continue
